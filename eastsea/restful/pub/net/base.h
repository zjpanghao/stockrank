...
#ifndef _HOME_RUNNER_NORTHSEA_RESTFUL_PUB_NET_BASE_H_
#define _HOME_RUNNER_NORTHSEA_RESTFUL_PUB_NET_BASE_H_
...
#endif  //  _HOME_RUNNER_NORTHSEA_RESTFUL_PUB_NET_BASE_H_
